        ...
        <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length<5 || note.edescription.length<5} onClick={handleClick} type="button" className="btn btn-primary">Udpate Note</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="row my-3">
                ...
                <div className="container">
                    {notes.length === 0 && "No Notes to display. Kindly add a new note."}
                </div>
